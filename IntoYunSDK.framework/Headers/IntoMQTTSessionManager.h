...
@class IntoMQTTSessionManager;


/** delegate gives your application access to received messages
 */
@protocol IntoMQTTSessionManagerDelegate <NSObject>

/**
 Enumeration of IntoMQTTSessionManagerState values
 */
typedef NS_ENUM(int, IntoMQTTSessionManagerState) {
    IntoMQTTSessionManagerStateStarting,
    IntoMQTTSessionManagerStateConnecting,
    IntoMQTTSessionManagerStateError,
    IntoMQTTSessionManagerStateConnected,
    IntoMQTTSessionManagerStateClosing,
    IntoMQTTSessionManagerStateClosed
};
...
/** gets called when the connection status changes
 @param sessionManager the instance of IntoMQTTSessionManager whose state changed
 @param newState the new connection state of the sessionManager. This will be identical to `sessionManager.state`.
 */
- (void)sessionManager:(IntoMQTTSessionManager *)sessionManager didChangeState:(IntoMQTTSessionManagerState)newState;
...
@interface IntoMQTTSessionManager : NSObject <MQTTSessionDelegate>


/** the delegate receiving incoming messages
 */
@property(weak, nonatomic) id <IntoMQTTSessionManagerDelegate> delegate;
 ...
 */
@property(nonatomic, readonly) IntoMQTTSessionManagerState state;
 ...
 * @return the initialized IntoMQTTSessionManager object
 */

- (IntoMQTTSessionManager *)initWithPersistence:(BOOL)persistent
...
/**
 * 订阅消息
 * @param newSubscriptions  新主题
 * @param subscribeHandler  订阅回调
 */
- (void)setSubscriptions:(NSDictionary<NSString *, NSNumber *> *)newSubscriptions subscribeHandler:(MQTTSubscribeHandler)subscribeHandler;
 ...
 * @param topic     topic
 */
-(void)unSubscriptions:(NSString *)topic;

/**
 * 取消订阅所有topics
 */
- (void)unAllSubscriptions;
