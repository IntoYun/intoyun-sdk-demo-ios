...
#import "IntoYunIMLinkManager.h"
#import "RecipeModel.h"

// appId
UIKIT_EXTERN NSString *sAppId;
// appSecret
UIKIT_EXTERN NSString *sAppSecret;

UIKIT_EXTERN BOOL sDebug;

@interface IntoYunSDKManager : NSObject
 ...
 * @param errorBlock    successBlock
 */
+ (void)getUserInfo:(SuccessBlock)successBlock
         errorBlock:(ErrorBlock)errorBlock;
 ...
 *    }
 */
+ (void)updateUserInfo:(NSMutableDictionary *)parameters
          successBlock:(SuccessBlock)successBlock
            errorBlock:(ErrorBlock)errorBlock;
 ...
 * @param errorBlock    successBlock
 */
+ (void)userLogout:(SuccessBlock)successBlock
        errorBlock:(ErrorBlock)errorBlock;
 ...
 * @param errorBlock    successBlock
 */
+ (void)changePassword:(NSString *)curPassword
